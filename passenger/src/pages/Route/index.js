    ...
    <View style={styles.container}>
      ...
      <View>
        ...
        {requested == false && confirmed == false && (
          <Fragment>
            <TouchableOpacity style={styles.botaoDrivers} onPress={goToDrivers}>
        ...
        {requested == true && confirmed == false && (
          <Fragment>
            <TouchableOpacity style={styles.botaoAwaiting} onPress={goToDriver}>
        ...
        {confirmed == true && (
          <Fragment>
            <TouchableOpacity style={styles.botaoDriver} onPress={goToDriver}>
